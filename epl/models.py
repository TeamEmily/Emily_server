...
class AuthGroupPermissions(models.Model):
    group = models.ForeignKey(AuthGroup, related_name='auth_group')
    permission = models.ForeignKey('AuthPermission', related_name='auth_permission')
...
class AuthPermission(models.Model):
    ...
    content_type = models.ForeignKey('DjangoContentType', related_name='auth_permission_ct')
...
class Game(models.Model):
    ...
    round = models.ForeignKey('Round', related_name='game_round')
...
class Stats(models.Model):
    ...
    fk_pl = models.ForeignKey(Players, related_name='pl')
    fk_game = models.ForeignKey(Game, related_name='stats_game')
    ...
    fk_round = models.ForeignKey(Game, related_name='stats_round')
    fk_team = models.ForeignKey(Players, related_name='stats_team')
